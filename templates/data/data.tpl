          ...
          <div class="col search-block">
            {if $showAdvancedSearchForm}
              <ul class="nav nav-tabs" id="searchforms">
                <li class="nav-item">
                  <a class="nav-link {if $searchform == 'simple'}active{/if}" data-toggle="tab" role="tab"
                    aria-selected="true" id="simple-search-tab" href="#simple-search"
                    aria-controls="simple-search-tab">simple search</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {if $searchform == 'advanced'}active{/if}" data-toggle="tab" role="tab"
                    aria-selected="true" id="advanced-search-tab" href="#advanced-search"
                    aria-controls="advanced-search-tab">advanced search</a>
                </li>
              </ul>
              <div class="tab-content" id="search-tabs">
                <div class="tab-pane {if $searchform == 'simple'}active{/if}" id="simple-search" role="tabpanel"
                  aria-labelledby="data-tab">
                  {include 'data/simple-search.tpl'}
                </div>
                <div class="tab-pane {if $searchform == 'advanced'}active{/if} record-tab" id="advanced-search"
          ...
          <div id="main" class="col">
            <div class="row">
              ...
              <div class="col-4 text-right" id="message">
                <a href="{$controller->getDownloadLink()}" title="{_('download identifiers')}"><i class="fa fa-download"
