  ...
  <tr class="t t-{$categoryId}-{$typeId} x-{$categoryId}-{$typeId}">
    <td class="path">
      <a class="clickMore clickMore-{$categoryId}-{$typeId}" data-id="{$categoryId}-{$typeId}" data-page="{$categoryId}-{$typeId}-0"
         href="?tab=issues&ajax=1&action=ajaxIssue&categoryId={$categoryId}&typeId={$typeId}&order=MarcPath ASC">
        <i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i></a>
      data element
      <a class="clickMore clickMore-{$categoryId}-{$typeId}" data-id="{$categoryId}-{$typeId}" data-page="{$categoryId}-{$typeId}-0"
         href="?tab=issues&ajax=1&action=ajaxIssue&categoryId={$categoryId}&typeId={$typeId}&order=MarcPath DESC">
        <i class="fa fa-arrow-circle-o-up" aria-hidden="true"></i></a>
    </td>
    <td class="message">
      <a class="clickMore clickMore-{$categoryId}-{$typeId}" data-id="{$categoryId}-{$typeId}" data-page="{$categoryId}-{$typeId}-0"
         href="?tab=issues&ajax=1&action=ajaxIssue&categoryId={$categoryId}&typeId={$typeId}&order=message ASC">
        <i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i></a>
      message
      <a class="clickMore clickMore-{$categoryId}-{$typeId}" data-id="{$categoryId}-{$typeId}" data-page="{$categoryId}-{$typeId}-0"
         href="?tab=issues&ajax=1&action=ajaxIssue&categoryId={$categoryId}&typeId={$typeId}&order=message DESC">
        <i class="fa fa-arrow-circle-o-up" aria-hidden="true"></i></a>
    </td>
    <td class="url"></td>
    <td class="count instances">
      <a class="clickMore clickMore-{$categoryId}-{$typeId}" data-id="{$categoryId}-{$typeId}" data-page="{$categoryId}-{$typeId}-0"
         href="?tab=issues&ajax=1&action=ajaxIssue&categoryId={$categoryId}&typeId={$typeId}&order=instances ASC">
        <i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i></a>
      <a class="clickMore clickMore-{$categoryId}-{$typeId}" data-id="{$categoryId}-{$typeId}" data-page="{$categoryId}-{$typeId}-0"
         href="?tab=issues&ajax=1&action=ajaxIssue&categoryId={$categoryId}&typeId={$typeId}&order=instances DESC">
        <i class="fa fa-arrow-circle-o-up" aria-hidden="true"></i></a>
    </td>
    <td class="count records">
      <a class="clickMore clickMore-{$categoryId}-{$typeId}" data-id="{$categoryId}-{$typeId}" data-page="{$categoryId}-{$typeId}-0"
         href="?tab=issues&ajax=1&action=ajaxIssue&categoryId={$categoryId}&typeId={$typeId}&order=records ASC">
        <i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i></a>
      <a class="clickMore clickMore-{$categoryId}-{$typeId}" data-id="{$categoryId}-{$typeId}" data-page="{$categoryId}-{$typeId}-0"
         href="?tab=issues&ajax=1&action=ajaxIssue&categoryId={$categoryId}&typeId={$typeId}&order=records DESC">
        <i class="fa fa-arrow-circle-o-up" aria-hidden="true"></i></a>
    </td>
    <td class="actions"></td>
    <td class="chart"></td>
