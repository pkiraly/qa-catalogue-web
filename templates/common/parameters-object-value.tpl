...
{elseif is_object($value)}
  {foreach from=get_object_vars($value) key=key item=item name=list}{$key}:<br>{include 'common/parameters-object-value.tpl' value=$item prefix="$prefix . . " suffix='<br>'}{/foreach}{$suffix}
