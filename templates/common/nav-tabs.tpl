...
<nav class="navbar navbar-expand-lg">
  <ul class="nav nav-tabs" id="myTab">
    {if $display['data']}
      <li class="nav-item">
        <a class="nav-link1{if $tab == 'data'} active{/if}" data-bs-toggle="tab1" role="tab1" aria-selected="false"
      ...
      <li class="nav-item dropdown">
        {if $catalogue->getSchemaType() == 'MARC21'}
          <a class="nav-link1 {if $isCompleteness}active{/if} dropdown-toggle"
             data-bs-toggle="dropdown" role="tab1" aria-selected="true"
        ...
        {elseif $catalogue->getSchemaType() == 'PICA'}
          <a class="nav-link1 {if $tab == 'completeness'}active{/if}" data-bs-toggle="tab1" role="tab1" aria-selected="false"
             id="completeness-tab" aria-controls="completeness"
    ...
    {if $display['issues'] || $display['shacl'] || $display['delta']}
      <li class="nav-item dropdown">
        ...
        {elseif $display['issues']}
          <a class="nav-link1 {if $tab == 'issues'}active{/if}" data-bs-toggle="tab1" role="tab1" aria-selected="false"
    ...
    {if $display['classifications'] || $display['authorities']}
      <li class="nav-item dropdown">
        <a class="nav-link1 {if $isAuthority}active{/if} dropdown-toggle" data-bs-toggle="dropdown" role="tab1" aria-selected="false"
    ...
    {if $display['pareto']}
      <li class="nav-item nav-item1 dropdown">
        <a class="nav-link1{if $tab == 'pareto'} active{/if}" data-bs-toggle="tab1" role="tab1" aria-selected="false"
    ...
    {if $display['history']}
      <li class="nav-item nav-item1 dropdown">
        <a class="nav-link1{if $tab == 'history'} active{/if}" data-bs-toggle="tab1" role="tab1" aria-selected="false"
    ...
    {if $display['timeline']}
      <li class="nav-item nav-item1 dropdown">
        <a class="nav-link1{if $tab == 'timeline'} active{/if}" data-bs-toggle="tab1" role="tab1" aria-selected="false"
    ...
    {if $display['network']}
      <li class="nav-item nav-item1 dropdown">
        <a class="nav-link1{if $tab == 'network'} active{/if}" data-bs-toggle="tab1" role="tab1" aria-selected="false"
    ...
    {if $display['terms'] || $display['data-element-timeline'] || $display['control-fields'] || $display['collocations'] || $display['download'] || $display['settings']}
      <li class="nav-item nav-item1 dropdown">
        <a class="nav-link1 {if $isTool}active{/if} dropdown-toggle" data-bs-toggle="dropdown" role="tab1" aria-selected="false"
    ...
    {if $display['about']}
      <li class="nav-item nav-item1 dropdown">
        <a class="nav-link1{if $tab == 'about'} active{/if}" data-bs-toggle="tab1" role="tab1" aria-selected="false"
